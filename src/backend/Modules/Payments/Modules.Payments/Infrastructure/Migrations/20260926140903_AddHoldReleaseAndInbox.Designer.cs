...
namespace TravelBooking.Modules.Payments.Infrastructure.Migrations
{
    ...
    [Migration("20260926140903_AddHoldReleaseAndInbox")]
    partial class AddHoldReleaseAndInbox
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TravelBooking.Modules.Payments.Domain.PaymentAttempt", b =>
                {
                    ...
                    b.ToTable("PaymentAttempts", "payments", t =>
                        {
                            t.HasCheckConstraint("CK_PaymentAttempts_Status", "[Status] IN ('Authorizing', 'ActionRequired', 'AuthorizationUnknown', 'Authorized', 'Declined', 'Canceled', 'Expired', 'Failed', 'ManualReview', 'Voiding', 'VoidUnknown', 'Voided')");
                        });
                });
