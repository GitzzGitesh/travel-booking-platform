...
- ADR 0004 and ADR 0014 are Proposed and need acceptance.
...
6. Known follow-ups from the skeleton reviews:
   ...
   - Provider port visibility (the ARCHITECTURE REVIEW raised in Phase 1): **addressed by ADR 0014** (Proposed, awaiting acceptance). Ports live in a public `Modules.<Area>.Ports` namespace, enforced by the architecture tests.
