...
**When:** credentials or commercial approval arrive for Duffel, Amadeus, Sabre or Travelport (Q6).
...
2. **Sandbox contract:** set the sandbox environment variables and run the contract suite: `dotnet test --project tests/backend/ProviderContracts`.
   ...
   - Amadeus: `AMADEUS_TEST_BASE_URL`, `AMADEUS_TEST_CLIENT_ID`, `AMADEUS_TEST_CLIENT_SECRET`.
